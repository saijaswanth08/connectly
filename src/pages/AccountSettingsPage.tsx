...
import { ShieldCheck, Lock, Check, X, Eye, EyeOff, KeyRound, ArrowLeft, CheckCircle2 } from "lucide-react";
import { z } from "zod";
            ...
            <CardContent>
              <form onSubmit={handleUpdate} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="currentPassword" className="text-xs font-medium text-muted-foreground flex items-center gap-1">
                ...
                {/* New Password */}
                <div className="space-y-1.5">
                  <Label htmlFor="newPassword" className="text-xs font-medium text-muted-foreground flex items-center gap-1">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      required
                      className={`rounded-lg h-10 pr-10 transition-colors ${
                ...
                {/* Security info note */}
                <p className="text-[11px] text-muted-foreground bg-muted/40 rounded-lg p-2.5 leading-relaxed flex items-start gap-1.5">
                  <ShieldCheck className="h-4 w-4 text-emerald-500 shrink-0 mt-0.5" />
                  Your password is updated directly and securely using industry-standard cryptography. No email verification is required since you are already logged in.
                </p>
