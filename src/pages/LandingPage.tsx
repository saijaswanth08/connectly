            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  {
                    label: "Instagram",
                    href: "https://www.instagram.com/connectly_crm?igsh=bHlwY3g4ZzkzeHh6",
                    icon: (
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {
                    label: "LinkedIn",
                    href: "https://www.linkedin.com/in/saijaswanth-nallamaru-1998a433b?utm_source=share_via&utm_content=profile&utm_medium=member_android",
                    icon: (
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
